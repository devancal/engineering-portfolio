...
function makeCadLoadingNotice(){
  ...
  return {
    set(text){notice.textContent=text;},
    done(){notice.textContent='Interactive CAD ready.';setTimeout(()=>{notice.style.opacity='0';setTimeout(()=>notice.remove(),260);},650);}
  };
}
